    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-white relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-8'}`}>
          <Card className="w-full h-auto min-h-[600px] bg-black/[0.96] relative overflow-hidden border-gray-800 backdrop-blur-sm">
            <Spotlight
            ...
            <div className="flex h-full flex-col lg:flex-row">
              {/* Left content */}
              <div className="flex-1 p-5 sm:p-8 lg:p-12 relative z-10 flex flex-col justify-center">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 leading-tight mb-4 sm:mb-6">
                  We create sophisticated
                  <br className="hidden sm:block" />
                  <span className="text-gray-300">high‑tech solutions</span>
                </h1>
                
                <p className="text-base sm:text-lg md:text-xl text-neutral-300 mb-6 sm:mb-8 max-w-2xl leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-4 sm:mb-6">
                  <button
                    ...
                    className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white text-black rounded-lg hover:bg-gray-100 transition-all duration-300 hover:shadow-lg hover:scale-105 w-full sm:w-fit relative overflow-hidden"
                  >
                    <span className="mr-2 font-semibold text-sm sm:text-base">Explore Our Services</span>
                  ...
                  <button
                    ...
                    className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-transparent border border-gray-600 text-white rounded-lg hover:bg-gray-800 hover:border-gray-500 transition-all duration-300 hover:shadow-lg hover:scale-105 w-full sm:w-fit relative overflow-hidden"
                  >
                ...
                <div className="flex flex-col xs:flex-row items-start xs:items-center xs:space-x-4 text-xs sm:text-sm text-gray-400">
                  <div className="flex items-center space-x-2 mb-2 xs:mb-0">
                    <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                    <span>Professional services available</span>
                  </div>
                  <div className="hidden xs:block w-1 h-4 bg-gray-600"></div>
